...
```bash
git clone https://github.com/sadi94787/swisstronik-deploy-private-nft.git
```
```bash
...
contract PrivateNFT is ERC721, Ownable {
    ...
    constructor(address initialOwner) ERC721("SadiPrivate", "SADPRVT") Ownable(initialOwner) {}
